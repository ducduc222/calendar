    ...
    return (
        <div style={{ display: 'flex'}}>
            ...
            <Container maxWidth="sm" style={{display: 'flex'}}>
                <Stack ref={stackRef1} spacing={3} style={{margin: 'auto', display: activeStack === 1 ? 'flex' : 'none'}}>
                    <h2>Quên mật khẩu?</h2>
                    <span>
                ...
                <Stack ref={stackRef2} spacing={3} style={{margin: 'auto', display: activeStack === 2 ? 'flex' : 'none'}}>
                    <h2>Xác thực OTP</h2>
                ...
                <Stack ref={stackRef3} spacing={3} style={{margin: 'auto', display: activeStack === 3 ? 'flex' : 'none'}}>
